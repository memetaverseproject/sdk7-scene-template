...
2. Install the [Decentraland Editor](https://docs.memetaverse.club/creator/development-guide/sdk7/editor/)
...
Below are some basic concepts about the SDK 7 syntax. For more details, see the [Documentation site](https://docs.memetaverse.club/creator/).
